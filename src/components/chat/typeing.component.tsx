...
const TypeingComponent = () => {
  ...
  return (
    <div className="bg-neutral-300 w-fit h-fit py-[5px] px-[10px] rounded-full animate-pulse flex gap-[5px] text-neutral-800 justify-center items-center select-none font-mono scale-90 italic mt-[3px]">
